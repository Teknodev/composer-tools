...
import styles from "./header37.module.scss";

import ComposerSlider from "../../../composer-base-components/slider/slider";
import ComposerLink from "../../../../custom-hooks/composer-base-components/Link/link";

class HeaderComponent37 extends BaseHeader {
          ...
          {this.getPropValue("slider").map(
            (item: any, indexSlider: number) => (
              ...
              <div className={this.decorateCSS("content")}>
                <img src={item.getPropValue("image")} key={indexSlider} />
...
export default HeaderComponent37;
