...
import styles from "./header36.module.scss";
...
class Header36 extends BaseHeader {
  constructor(props?: any) {
    ...
    this.addProp({
      ...
      displayer: "Image",
      value:
        "https://dentalexcellenceturkey.com/wp-content/themes/dectheme/images/page1.jpg",
    });
    this.addProp({
        type: "array",
        key: "right-items-1",
        displayer: "Right Items 1",
        value: [
          {
            type: "object",
            key: "item",
  ...
  render() {
          ...
          >
            <div
              className={this.decorateCSS("container")}>
                <div className={this.decorateCSS("logo-text")}>
                 {this.getPropValue("right-items-1").map((item: any, index: number) => (
    <div key={`svg-container-${index}`} className={this.decorateCSS("svg-container")}>
      <svg
        key={`logo-header36${index}`}
        width="40"
        height="40"
        viewBox="0 0 512 512"
        fill="currentColor"
      ...
      >
       <path d="M361.924,114.899c0.007,0,0.015,0.007,0.023,0.007h0.046L361.924,114.899z"/>
	<path  d="M492.539,59.454l0.008-0.024c-0.155-0.046-20.926-6.947-38.596-11.304
	...
	<path  d="M150.014,114.906h0.047c0.008,0,0.015-0.007,0.023-0.007L150.014,114.906z"/>
	<path d="M370.297,224.882c-6.652-16.872-10.452-31.472-12.568-41.761c-1.054-5.14-1.69-9.196-2.062-11.924
	...
	<path d="M256.004,426.378c43.792-0.015,79.38-35.604,79.396-79.396c-0.015-43.791-35.604-79.38-79.396-79.395
	...
	<path d="M256.004,386.681c21.92,0,39.698-17.771,39.698-39.698c0-21.918-17.778-39.698-39.698-39.698
		c-21.919,0-39.698,17.779-39.698,39.698C216.306,368.91,234.085,386.681,256.004,386.681z"/>
      </svg>
      </div>
      ))}
              <h6 className={this.decorateCSS("first-text")}> {this.getPropValue("first-text")}</h6>
        </div>
