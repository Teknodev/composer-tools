...
class Team8 extends Team {
  ...
  componentDidUpdate(prevProps: any) {
    console.log(prevProps, "prevPropsprevProps");
    const newSlidesToShow = this.getPropValue("slidesToShow");
    console.log(newSlidesToShow, "newSlidesToShow");
    if (prevProps.slidesToShow !== newSlidesToShow) {
      this.setComponentState("slidesToShow", newSlidesToShow);
      console.log(prevProps);
      console.log(prevProps.slidesToShow);
    }
  }
                          ...
                          <Base.VerticalContent className={this.decorateCSS("content-div")}>
                            ...
                            {(titleExist || subtitleExist) && (
                              <Base.VerticalContent className={this.decorateCSS("header-page")}>
                                {titleExist && <Base.P className={this.decorateCSS("item-title")}>{item.imagetitle}</Base.P>}
                                {subtitleExist && <Base.H2 className={this.decorateCSS("first-header")}>{item.imagesubtitle}</Base.H2>}
                              </Base.VerticalContent>
                            )}
                          </Base.VerticalContent>
                        </div>
