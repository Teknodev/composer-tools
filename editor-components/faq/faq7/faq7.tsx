          ...
          value: [
            {
              ...
              key: "title",
              displayer: "Title",
              value: "Why should I have my Dental Implants in Turkey?",
            },
            {
              type: "string",
              key: "description",
          ...
          value: [
            {
              ...
              key: "title",
              displayer: "Title",
              value: "How long does the dental implant procedure take?",
            },
            {
              type: "string",
              key: "description",
          ...
          value: [
            {
              ...
              key: "title",
              displayer: "Title",
              value: " How can I overcome dental anxiety?",
            },
            {
              type: "string",
              key: "description",
          ...
          value: [
            {
              ...
              key: "title",
              displayer: "Title",
              value: "What is Digital Smile Design?",
            },
            {
              type: "string",
              key: "description",
          ...
          value: [
            {
              ...
              key: "title",
              displayer: "Title",
              value: "How to Care for Dental Veneers?",
            },
            {
              type: "string",
              key: "description",
          ...
          <div className={this.decorateCSS("page")}>
            ...
            {cardList.length > 0 && (
              <div className={this.decorateCSS("down-page")}>
                {cardList.map((card: Card, indexCard: number) => {
                          ...
                          >
                            <ComposerIcon
                              name={
                                ...
                                indexCard
                                  ? this.getPropValue("collapseIcon")
                                  : this.getPropValue("expandIcon")
                              }
                            />
                          </div>
                        </div>
