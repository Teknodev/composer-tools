          ...
          <div id={"right-content"} className={this.decorateCSS("right-content")}>
            <Base.VerticalContent className={this.decorateCSS("card")}>
              <Base.VerticalContent className={this.decorateCSS("card-up")}>
                {cardSubtitle && <Base.H5 className={`${this.decorateCSS("card-subtitle")} ${alignment === "center" && this.decorateCSS("center-badge")}`}>{cardText?.cardSubtitle}</Base.H5>}
                {cardTitle && <Base.H3 className={this.decorateCSS("cardTitle")}>{cardText?.cardTitle}</Base.H3>}
                {cardDescription && <Base.P className={this.decorateCSS("cardDescription")}>{cardText?.cardDescription}</Base.P>}
                {listExist && (
