                    ...
                    <div className={this.decorateCSS("page")}>
                        <div className={this.decorateCSS("left-container")}>
                            <div className={this.decorateCSS("badge")}>
                                <img src="https://cdn-icons-png.flaticon.com/512/9437/9437505.png" alt="hello" className={this.decorateCSS("hand-image")} />
                                <h1 className={this.decorateCSS("badge-text")}>{this.getPropValue("badge")}</h1>
                            </div>
                            ...
                            <div className={this.decorateCSS("stats")}>
                                <h1 className={this.decorateCSS("subtitle")}>{this.getPropValue("text1")}</h1>
                                <div className={this.decorateCSS("down-description")}>
                                    <div className={this.decorateCSS("stars")}>
                                        <StarBorderIcon width={30} className={this.decorateCSS("star")} />
                                        <StarBorderIcon width={30} className={this.decorateCSS("star")} />
                                        <StarBorderIcon width={30} className={this.decorateCSS("star")} />
                                        <StarBorderIcon width={30} className={this.decorateCSS("star")} />
                                        <StarBorderIcon width={30} className={this.decorateCSS("star")} />
                                    ...
                                    <p className={this.decorateCSS("info")}>{this.getPropValue("text2")}</p>
                                </div>
                            </div>
                        </div>
                        <div className={this.decorateCSS("right-container")}>
                            <img className={this.decorateCSS("right-image")} src={Image} alt="" />
                        </div>
                    </div>
                </div>
            </div>
