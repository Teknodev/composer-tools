...
class Slider8 extends BaseSlider {
  ...
  render() {
    ...
    const cards = this.castToObject<Card[]>('header');
              ...
              {cards?.length && cards?.length > 0 && (
                <Slider
                  ...
                  {cards.map((item: Card, index: number) => {
                    ...
                    const render =
                      titleExists || buttons?.length > 0 || item.image;
                          ...
                          `}>
                            {linesContainer && (
                              <div
                                ...
                                <div
                                  className={this.decorateCSS('line-1')}></div>
                                <div
                                  className={this.decorateCSS('line-2')}></div>
                              </div>
                            )}
                            ...
                            <div
                              ...
                              {shouldDisplayForegroundOverlay(index) ===
                                true && (
                                <div
                            ...
                            {buttons?.length > 0 && (
                              <div
                                ...
                                {buttons.map(
                                  (item: Button, buttonIndex: number) => {
