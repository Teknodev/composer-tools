...
class CallToAction34 extends BaseCallToAction {
    constructor(props?: any) {
        ...
        this.addProp({
            ...
            displayer: "Buttons",
            value:
                [INPUTS.BUTTON("button", "Button", "Sing Up Online", "", null, null, "White")],
    ...
    render() {
        ...
        const hasButtons = buttons.some(btn => {
            return this.castToString(btn.text) || btn.icon;
        });

        const hasLeftContent = subtitle || title || description || hasButtons;
