                    ...
                    {cards.length > 0 && (
                        ...
                        >
                            {cards.map((card: ProductCard, cardIndex: number) => {
                                ...
                                const hasCardImage = cardImage && !!cardImage.url;
                                const hasHoverImage = hoverImage && !!hoverImage.url;
                                ...
                                const isRatingImage = ratingIcon && ratingIcon.type === "image";
                                ...
                                const isLabelSeparatorImage = labelSeparatorIcon && labelSeparatorIcon.type === "image";
                                const enablePriceSeparator = card.enablePriceSeparator;
                                const priceSeparatorIcon = card.priceSeparatorIcon;
                                const isPriceSeparatorImage = priceSeparatorIcon && priceSeparatorIcon.type === "image";
