...
@container (max-width: #{$composer-tablet-width}) {
  .container .max-content .wrapper .stats-grid {
    gap: var(--composer-gap-md);

    .card .stat-value .stat-number,
    .card .stat-value .stat-suffix {
      font-size: 4rem;
    }
  }
}
      ...
      .stat-item {
        ...
        .stat-header {
          ...
          .stat-value {
            ...
            .stat-suffix {
              font-size: 5rem;
              color: var(--composer-color-primary);
            }
          }
...
@container (max-width: #{$composer-tablet-width}) {
  .container .max-content .wrapper .stats-grid {
    ...
    .stat-item .stat-header .stat-value {
      .stat-number,
      .stat-suffix {
        font-size: 4rem;
      }
